...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        tableClient.UpsertEntity(funcionarioLog); // Salva o funcionário no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        _context.Funcionarios.Update(funcionarioBanco); // Salva a atualização no Banco SQL
    ...
    public IActionResult Deletar(int id)
    {
        ...
        _context.Funcionarios.Remove(funcionarioBanco); // Remove o funcionário do Banco SQL
        _context.SaveChanges();
